...
// <if enableBYOKTDE> --------------------------------------------------------------------------------
module keyVaultModule 'keyvault.bicep' = if (enableBYOKTDE) {
...
module keyVaultKeySqlDte 'keyvaultkeysqldte.bicep' = if (enableBYOKTDE) {
...
module sqlDbEncryption 'sqlserverbyoktde.bicep' = if (enableBYOKTDE) {
